...
async function compilePlugins() {
  ...
  const request = process.env.APP_ENV !== "test" ? await fetch("https://raw.githubusercontent.com/Lukasdotcom/fantasy-manager/plugins/store/default_store.json").catch(
    () => {
